...
%% FORMULA LOOKUP
W --> X{Pergunta sugere formula? ('como calcular', 'formula', ...)}:::middleware
...
Z -->|Nenhuma| Y
Z1 --> AA[Montar prompt final com historico + contexto + pergunta]:::service
Y --> AA
...
AD --> AE[Montar JSON final {response, sources}]:::handler
AE --> AF[Retornar resposta ao cliente HTTP 200 OK]:::handler
